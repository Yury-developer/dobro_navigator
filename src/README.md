...
[Видео-урок4 "Spring Boot JPA (Hibernate): добавляем базу данных в веб приложение на Java (простой сайт)"](https://youtu.be/nyFLX3q3poY)

[Ссылка на git репозиторий из видео](https://github.com/drucoder/sweater/tree/JPA_Postgres)
...
[гайд на сайте Spring](https://spring.io/guides/gs/accessing-data-mysql/)
